  ...
  return (
    <section id="shop" className="bg-gray-50 py-20 px-6">
      <div className="max-w-xl mx-auto text-center">
        ...
        <div className="w-12 h-1 bg-gradient-to-r from-teal-500 to-teal-400 rounded-full mx-auto mt-4 mb-10" />

        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-10 hover:shadow-md transition-shadow duration-300">
          <div className="w-16 h-16 bg-teal-50 rounded-full flex items-center justify-center mx-auto mb-5">
            <svg className="w-8 h-8 text-teal-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z" />
            </svg>
          </div>
          <p className="text-xl font-black text-gray-900 mb-2">Coming Soon</p>
          ...
          <a
            ...
            className="inline-block bg-teal-600 text-white px-7 py-3 rounded-full font-semibold text-sm hover:bg-teal-700 transition-all duration-300 shadow-sm hover:shadow-md"
          >
            Get Notified
          </a>
        </div>
